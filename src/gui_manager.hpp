...
struct GUIManager
{
  ...
  // previous vertex task buffer
  daxa::TaskBuffer task_line_previous_vertex_buffer{{.initial_buffers = {}, .name = "GUI line task previous vertex buffer"}};
  ...
  daxa::BufferId get_line_previous_vertex_buffer();
