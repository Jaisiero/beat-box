...
struct SceneManager
{
  ...
  bool load_scene()
  {
    ...
    aabb = {{.minimum = daxa_f32vec3(-5.0, -5.0, -5.0), .maximum = daxa_f32vec3(5.0, 5.0, 5.0)}, {.minimum = daxa_f32vec3(-0.5, -0.5, -0.5), .maximum = daxa_f32vec3(0.5, 0.5, 0.5)}, {.minimum = daxa_f32vec3(-1.0, -1.0, -1.0), .maximum = daxa_f32vec3(1.0, 1.0, 1.0)}, {.minimum = daxa_f32vec3(-0.5, -0.5, -0.5), .maximum = daxa_f32vec3(0.5, 0.5, 0.5)}};
